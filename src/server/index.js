...
fs.writeFileSync("../output/Valuable_Player.json",converting_Players_to_string,'utf-8')
 ...
 fs.writeFileSync("../output/Number_Of_Times_Winning_Toss_Team_Won_The_Match.json", converting_teams_to_string,'utf-8')
 //strike rate of Virat kholi for each season
 var strikeRateVirat=frr.strikeRateOfVirat(matches,deliveries)
 var converting_strikeRateVirat_to_string=JSON.stringify(strikeRateVirat)
 fs.writeFileSync("../output/Strike_Rate_Of_Virat_Kholi_Every_Season.json", converting_strikeRateVirat_to_string,'utf-8')
 var bowler=frr.bowlerWithBestEconomy(deliveries)
 var converting_bowler_to_string=JSON.stringify(bowler)
 fs.writeFileSync("../output/Bowler_Which_Has_Best_Economy_In_Super_Over.json", converting_bowler_to_string,'utf-8')
 ...
 fs.writeFileSync("../output/Number_Of_Times_One_Player_dismissed_Other_Player.json", converting_dismissed_to_string,'utf-8')
